...
For compositions that need interactive preview in browser, use the **Player Preview Template**:

- **[references/player-template.md](references/player-template.md)** — Complete template with fixed bottom control bar, scene jump buttons, play/pause toggle, and auto-dismissing tip. Ideal for educational content and interactive tutorials.

This template generates self-contained HTML with:
- Fixed position controls at bottom (never block content)
- Scene navigation buttons
- Play/pause state toggle
- Top hint that auto-hides after 6 seconds
